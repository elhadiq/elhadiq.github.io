...
\institute{Professeur agrégé d'informatique -- CPGE Moulay Youssef\\Fondateur de la plateforme \texttt{cpgeacademy.org}}
...
\begin{frame}{Alignement profil-sujet}
  \begin{columns}
    ...
    \begin{itemize}
      \item Professeur agrégé d'informatique, expérience terrain CPGE (MP/PSI).
...
\begin{frame}{Contributions attendues}
  \begin{columns}
    ...
    \begin{itemize}
      ...
      \item Publications ciblées (AIED, EDM, IJAIED).
    \end{itemize}
    \column{0.5\textwidth}
...
\begin{frame}{Conclusion}
  ...
  \begin{block}{Ouverture}
    Je suis prêt à détailler l'architecture technologique, les protocoles d'évaluation ou les collaborations envisagées.
  \end{block}
\end{frame}
